...
describe("asm_lsp", function()
  helpers.setup_server("asm_lsp", {
    root_dir = util.root_pattern("root-marker"),
  })

  it("starts", function()
    vim.api.nvim_command("bufdo bwipeout!")
    vim.api.nvim_command("new | only | find fixtures/example-project-1/my-project/main.asm")
    ...
    assert.equal("asm_lsp", buf_clients[1].name)
