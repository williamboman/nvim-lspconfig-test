...
describe("zeta_note", function()
  helpers.setup_server("zeta_note", {})

  it("starts", function()
    vim.api.nvim_command("bufdo bwipeout!")
    vim.api.nvim_command("new | only | silent edit fixtures/example-project-1/src/index.md")
    ...
    assert.equal("zeta_note", buf_clients[1].name)
