...
describe("vala_ls", function()
  ...
  it("starts", function()
    ...
    vim.api.nvim_command("new | only | find fixtures/example-project-1/my-project/main.vala")
  ...
  it("works with single file support", function()
    vim.api.nvim_command("bufdo bwipeout!")
    vim.api.nvim_command("new | only | silent edit fixtures/example-project-2/main.vala")
    vim.api.nvim_command("set ft=vala")
    helpers.wait_for_ready_lsp()
